...
Pressing the handle immediately arms the gray line. Users can drag without waiting. Accidental taps still leave the saved position unchanged. Keyboard, paging, overlay locators, and both sort modes stay as they are.
