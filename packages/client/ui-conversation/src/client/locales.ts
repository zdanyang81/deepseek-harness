...
export const zh = {
  ...
  'hover.firstPrompt': '最开始的问题',
  'hover.firstPromptLoading': '正在读取…',
  'hover.copyFirstPrompt': '复制最开始的问题',
  'hover.copied': '已复制',
  'todo.title': '任务',
...
export const en = {
  ...
  'hover.firstPrompt': 'First question',
  'hover.firstPromptLoading': 'Loading…',
  'hover.copyFirstPrompt': 'Copy first question',
  'hover.copied': 'Copied',
  'todo.title': 'To-dos',
